...
if (Test-Path $EnvTemplatePath) {
    ...
    Write-Success "[OK] Created .env from template with GitHub token and database passwords"
}
else {
...
"@
    Set-Content -Path $EnvPath -Value $EnvContent -Force
    Write-Success "[OK] Created .env configuration with GitHub token and database passwords"
}
